        ...
        <tr key={item.commit}>
          ...
          <td className="hidden py-4 pr-4 pl-0 sm:table-cell sm:pr-8">
            <div className="flex gap-x-3">
              <div className="font-mono text-sm/6 text-gray-600">{item.commit}</div>
              <span className="inline-flex items-center rounded-md bg-gray-100 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-gray-200 ring-inset">
                {item.branch}
              </span>
            </div>
          </td>
          ...
          <td className="hidden py-4 pr-8 pl-0 text-sm/6 text-gray-600 md:table-cell lg:pr-20">
            {item.duration}
          </td>
